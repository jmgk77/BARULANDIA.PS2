...
#ifdef PS2
#define SDL_CONTROLLER_BUTTON_SQUARE 0
#define SDL_CONTROLLER_BUTTON_CROSS 1
#define SDL_CONTROLLER_BUTTON_CIRCLE 2
#define SDL_CONTROLLER_BUTTON_TRIANGLE 3
#define SDL_CONTROLLER_BUTTON_SELECT 4
#define SDL_CONTROLLER_BUTTON_START 5
#define SDL_CONTROLLER_BUTTON_L1 6
#define SDL_CONTROLLER_BUTTON_R1 7
#define SDL_CONTROLLER_BUTTON_R2 8
#define SDL_CONTROLLER_BUTTON_L2 9
